...
signal_eff = {"200_275":{"0.51":0.012,"0.52":0.013,"0.53":0.032,"0.54":0.053,"0.55":0.123,"0.56":0.310,"0.57":0.512,"0.58":0.679,"0.59":0.795,"0.6":0.795,"0.61":0.795,"0.62":0.795,"0.63":0.795,"0.65":0.795,"2.":0.792},"225_275":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.6":1.0,"2.":1.0},"275_325":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.6":1.0,"2.":1.0},"325_375":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.6":1.0,"2.":1.0},"375_475":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0},"475_575":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0},"575_675":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0},"675_775":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0},"775_875":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0},"875":{"0.51":1.0,"0.52":1.0,"0.53":1.0,"0.54":1.0,"0.55":1.0,"0.56":1.0,"0.57":1.0,"0.58":1.0,"0.59":1.0,"0.60":1.0,"2.":1.0}}

muon_eff = {"200_275":0.88,"275_325":0.88,"325_375":0.88,"375_475":0.88,"475_575":0.88,"575_675":0.88,"675_775":0.88,"775_875":0.88,"875":0.88,}
bulk_eff = {"200_275":0.859,"275_325":0.876,"325_375":1.0,"375_475":1.0,"475_575":1.0,"575_675":1.0,"675_775":1.0,"775_875":1.0,"875":1.0,}

dir = "./June_19_Root_Files"
...
def Hist_Rebinner(histtype,plot,name,xrange = [],yrange = []):
        ...
        newhist = r.TH2F(name,"",len(xrange)-1,array.array('d',xrange),len(yrange)-1,array.array('d',yrange))

        for xbin in range(1,newhist.GetNbinsX()+1):
           for ybin in range(1,newhist.GetNbinsY()+1):
               
                alphaT_efficiency = 1.0
                if name == "HadMC" and histtype == "Signal": alphaT_efficiency = signal_eff[htbin][str(yrange[ybin-1])] 
 
                newhist.SetBinContent(xbin,
				      ybin, 
				      plot.Integral(plot.GetXaxis().FindBin(xrange[xbin-1]),
						    plot.GetXaxis().FindBin(xrange[xbin])-1, 
						    plot.GetYaxis().FindBin(yrange[ybin-1]), 
						    plot.GetYaxis().FindBin(yrange[ybin])-1)*alphaT_efficiency)

        return newhist


def EWK_Prediction(histtype,muon_mc,had_mc,muon_data,htbin,xrange = [], yrange = []):

        new_mu_mc = Hist_Rebinner(histtype,muon_mc,"MuonMC",xrange = xrange,yrange=yrange)
...
def EWK_Subtraction(bulk_hist,signal_hist,ewk_hist_low,ewk_hist_high,htbin,xrange = [], 
        ...
        final_prediction = Prediction_Adder(qcd_bulk_prediction,qcd_sig_prediction,0.57,1.25)
...
def Ratio_Producer(qcd_histogram):
        ...
        for ybin in range(1,ratio_plot.GetNbinsY()+1):
             ...
             if ybin != 1:
               qcd_estimation.SetBinContent(1,ybin,(qcd_histogram.GetBinContent(1,ybin-1)/qcd_histogram.GetBinContent(2,ybin-1))*qcd_histogram.GetBinContent(2,ybin))
             else:
...
for bin in htbins:
    ...
    #ewk_pred_lower = EWK_Prediction("Bulk",muon_mc_hist,had_bulk_mc_hist,muon_data_hist,bin+"_bulk_pred",xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.54,0.55,0.56,0.57,0.58,0.59,0.6,0.65] )
    #ewk_pred_higher = EWK_Prediction("Signal",muon_mc_hist,had_parked_mc_hist,muon_data_hist,bin+"_signal_pred",xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.54,0.55,0.56,0.57,0.58,0.59,0.6,0.65] )

    #EWK_Subtraction(had_bulk_data_hist,had_parked_data_hist,ewk_pred_lower,ewk_pred_higher, bin,xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.54,0.55,0.56,0.57,0.58,0.59,0.6,0.65] )

    ewk_pred_lower = EWK_Prediction("Bulk",muon_mc_hist,had_bulk_mc_hist,muon_data_hist,bin+"_bulk_pred",xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.57,0.6,0.65] )
    ewk_pred_higher = EWK_Prediction("Signal",muon_mc_hist,had_parked_mc_hist,muon_data_hist,bin+"_signal_pred",xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.57,0.6,0.65] )

    EWK_Subtraction(had_bulk_data_hist,had_parked_data_hist,ewk_pred_lower,ewk_pred_higher, bin,xrange = [0.0,1.25,5.0],yrange = [0.51,0.52,0.53,0.57,0.6,0.65])
